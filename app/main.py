...
st.write("TA Score:", ta.get("score", 0))
st.write("Volatility Regime:", ta.get("volatility_regime", "Unavailable"))
st.write("Trend Strength:", ta.get("trend_strength", "Unavailable"))
