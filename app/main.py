...
st.caption("Auto Liquidity Intelligence System • LP-first • Risk-aware")
...
# -----------------------------
st.markdown("## 🔵 Live Solana (SOL) Price")
...
# -----------------------------
st.markdown("## 📊 Autogenerated Liquidity Range")
...
# -----------------------------
st.markdown("## 🧠 Fundamental Risk Signals")
...
render_news("🪙 Crypto News", fa_output.get("crypto_news", []))
render_news("🌍 Macro News", fa_output.get("macro_news", []))
